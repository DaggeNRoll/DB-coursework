    ...
    $.extend(
        altEditor.prototype,
        {
            ...
            _initLanguage: function () {
                ...
                this.language.edit = {
                    title: this.language.edit.title || 'Редактировать запись',
                    button: this.language.edit.button || 'Редактировать'
                };
                this.language.delete = this.language.delete || {};
                this.language.delete = {
                    title: this.language.delete.title || 'Удалить запись',
                    button: this.language.delete.button || 'Удалить'
                };
                this.language.add = this.language.add || {};
                this.language.add = {
                    title: this.language.add.title || 'Добавить запись',
                    button: this.language.add.button || 'Добавить'
                };
            ...
            _openDeleteModal: function () {
                ...
                var fill = function () {
                    ...
                    $(selector).find('.modal-body').html(that.language.deleteMessage || `<h6>Вы уверены, что хотите удалить ${adata.count()} запись?</h6> <h8 class="text-warning">Это действие необратимо</h8>`);
